...
class ZipatoDevice extends ZwaveDevice {
	...
	async onNodeInit() {
		...
		this.homey.flow.getConditionCard('WT-RFID.BENEXT-is_at_home')
		...
		this.homey.flow.getConditionCard('WT-RFID.BENEXT-system_is_armed')
			.registerRunListener(( args, state, callback ) => {
				return callback(null, this.isSystemArmed());
			});

		this.homey.flow.getActionCard('WT-RFID.BENEXT-toggle_person_home')
			.registerRunListener(( args, state, callback ) => {
		...
		this.homey.flow.getActionCard('WT-RFID.BENEXT-toggle_person_away')
			.registerRunListener(( args, state, callback ) => {
		...
		this.userSystemAwayTrigger = this.homey.flow.getDeviceTriggerCard('WT-RFID.BENEXT-user_system_away');
		this.userSystemHomeTrigger = this.homey.flow.getDeviceTriggerCard('WT-RFID.BENEXT-user_system_home');
		this.userHomeTrigger = this.homey.flow.getDeviceTriggerCard('WT-RFID.BENEXT-user_home');
		this.userAwayTrigger = this.homey.flow.getDeviceTriggerCard('WT-RFID.BENEXT-user_away');
		this.userUnknownTrigger = this.homey.flow.getDeviceTriggerCard('WT-RFID.BENEXT-user_unknown');
	}
